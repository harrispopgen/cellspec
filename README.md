...
There are several alternative options to install cellspec:

<!--
1) Install the latest release of `cellspec` from [PyPI][]:
...
```bash
pip install git+https://github.com/harrispopgen/cellspec.git@main
```
